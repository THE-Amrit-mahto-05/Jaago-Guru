  ...
  return (
    <div className="min-h-screen bg-[#FDFCF8] flex items-center justify-center px-4 py-12 relative overflow-hidden font-sans text-neutral-900">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Card: Technical, Bordered, No Shadow */}
        <div className="bg-white border border-neutral-200 p-8 rounded-sm shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)]">
          ...
          <div className="mb-8">
            ...
            <p className="text-neutral-500 text-sm">Sign in to continue your progress.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Email Field */}
            <div>
              <label className="block text-neutral-900 font-bold mb-2 text-xs uppercase tracking-wider">
                Email Address
              </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-neutral-900 font-bold text-xs uppercase tracking-wider">
                  Password
                </label>
              </div>
              <div className="relative">
