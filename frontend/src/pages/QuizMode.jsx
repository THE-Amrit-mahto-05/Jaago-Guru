  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-4xl">
        <div
          onClick={() =>
            navigate(`/interview/quiz?subject=${subject}&topic=${topic}&mode=mcq`)
          }
        ...
        <div
          onClick={() =>
            navigate(`/interview/quiz?subject=${subject}&topic=${topic}&mode=subjective`)
          }
          className="cursor-pointer p-8 rounded-2xl shadow-lg text-white 
        ...
        <div
          onClick={() =>
            navigate(`/interview/quiz?subject=${subject}&topic=${topic}&mode=session`)
          }
          className="cursor-pointer p-8 rounded-2xl shadow-lg text-white 
